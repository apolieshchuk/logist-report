...
ROUTE_INFO_PATTERN = ["id", "name", "auto_num", "dr_surn",
                      "tel"]  # шаблон для внесения инфы по загрузке согласно ID авто
...
#             "ПолещукАИ","ЗаливнойМ","БуртникР","КОММЕРЦИЯ","ШарпакВ","РудаО","KSG","БочковскаяИА"]

CROPS = ["соняшник", "пшениця", "кукуруза", "соя", "висівки", "ячмінь", 'мука',"шрот","інше"]
