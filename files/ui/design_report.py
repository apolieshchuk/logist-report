...
class Ui_ReportWindow(object):
    def setupUi(self, ReportWindow):
        ...
        self.autoToday_but = QtWidgets.QPushButton(self.centralwidget)
        self.autoToday_but.setObjectName("autoToday_but")
        self.gridLayout.addWidget(self.autoToday_but, 0, 1, 1, 1)
        self.autoInTime_but = QtWidgets.QPushButton(self.centralwidget)
        self.autoInTime_but.setObjectName("autoInTime_but")
        self.gridLayout.addWidget(self.autoInTime_but, 1, 1, 1, 1)
        self.excel_but = QtWidgets.QPushButton(self.centralwidget)
        self.excel_but.setObjectName("excel_but")
        self.gridLayout.addWidget(self.excel_but, 0, 0, 1, 1)
        self.clear_filer_but = QtWidgets.QPushButton(self.centralwidget)
        self.clear_filer_but.setObjectName("clear_filer_but")
        self.gridLayout.addWidget(self.clear_filer_but, 1, 0, 1, 1)
    ...
    def retranslateUi(self, ReportWindow):
        ...
        self.autoToday_but.setText(_translate("ReportWindow", "Авто сегодня"))
        self.autoInTime_but.setText(_translate("ReportWindow", "Авто за период"))
